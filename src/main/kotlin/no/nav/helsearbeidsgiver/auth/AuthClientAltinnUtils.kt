...
fun AuthClient.getPdpToken() = hentAltinnToken(Env.getProperty("ALTINN_PDP_SCOPE"))

fun AuthClient.getDialogportenToken() = hentAltinnToken(Env.getProperty("DIALOGPORTEN_SCOPE"))
